  ...
  function renderS5() {
    ...
    el.innerHTML = `
      ...
      <div class="wz-rec-card">
        ...
        <a class="wz-rec-cta" href="https://datengraf.nozilla.de" target="_blank" rel="noopener noreferrer">
          Datengraf öffnen
      ...
      <div class="wz-rec-card">
        ...
        <a class="wz-rec-cta" href="https://datenlotse.nozilla.de" target="_blank" rel="noopener noreferrer">
          Datenlotse öffnen
          <i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i>
          <span class="visually-hidden">(externer Link, öffnet in neuem Tab)</span>
        </a>

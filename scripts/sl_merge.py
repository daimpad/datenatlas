#!/usr/bin/env python3
"""Merge S-L agent outputs into sector JSON files."""
import json, os
...
AGENT_FILES = {
    'staat': ['/tmp/sl_agent_1.json', '/tmp/sl_agent_2.json', '/tmp/sl_agent_3.json',
              '/tmp/sl_agent_4.json', '/tmp/sl_agent_5.json'],
    'wirtschaft': ['/tmp/sl_agent_6.json', '/tmp/sl_agent_7.json'],
    'wissenschaft': ['/tmp/sl_agent_8.json', '/tmp/sl_agent_9.json'],
    'zivilgesellschaft': ['/tmp/sl_agent_10.json', '/tmp/sl_agent_11.json'],
    'medien': ['/tmp/sl_agent_12.json', '/tmp/sl_agent_13.json'],
    'religion': ['/tmp/sl_agent_14.json'],
    'bildung': ['/tmp/sl_agent_15.json'],
}
